    ...
    <div class="col-12 col-md-8">
        <div class="app-card app-card-settings shadow-sm p-4">
            <div class="app-card-body">
                <form class="settings-form" method="POST" action="/add" >
                    @csrf
                   
                    <div class="mb-3">
                        <label for="setting-input-2" class="form-label">Өнім атауы                        </label>
                       
                        <input type="text" class="form-control" id="setting-input-2" name="titre" required>
                    </div>

                    <div class="mb-3">
                        <label for="setting-input-3" class="form-label"> саны
                        </label>
                        <input type="text" class="form-control" id="setting-input-2" name="qte" required>
                    </div>

                    <div class="mb-3">
                        <label for="setting-input-3" class="form-label">
                            бірлік сатып алу бағасы
                        </label>
                        <input type="text" class="form-control" id="setting-input-2" name="prixa" required>
                    </div>

                    <div class="mb-3">
                        <label for="setting-input-3" class="form-label">бірлік сату бағасы</label>
                        <input type="text" class="form-control" id="setting-input-2" name="prixv" required>
                    </div>
                    <button type="submit" class="btn app-btn-primary">қосу
                    </button>
                </form>
            </div>
        </div>
